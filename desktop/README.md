...
| `bun run build:ui` | Builds `../ui` in standalone mode with `NEXT_PUBLIC_API_BASE_URL=http://127.0.0.1:5050`, `NEXT_PUBLIC_INDEXER_MODE=lite`, `NEXT_PUBLIC_MINA_NETWORK=testnet`, and `NEXT_PUBLIC_MINA_NETWORK_DOMAIN=testnet`. |
